...
// 		if (M == null || !ishuman(M) || M.stat != 0 || M.paralysis > 0 || !pounce)
// 			interrupt(INTERRUPT_ALWAYS)
// 			return

// 		M.visible_message("<span style=\"color:red\"><b>[M] crouches down as it prepares to pounce!!!</span>")
...
// 		var/mob/living/M = owner
// 		M.weakened+=3
// 		M.visible_message("<span style=\"color:red\"><b>[M] tripped before it could pounce!!</span>")
